...
int main()
{
    ...
    Potential<double> V;
    double u=0.2, b=0.9, m=1.0, dr = 1e-6;
    b *= V.Rcut;
    ...
    //double param[4] = {u*u, u*b, u*u*b*b, 2/m};
    //for(int i=0; i<V.Nsteps; i++) std::cout << V.Rsteps[i] << " " << rDotSquared(V.Rsteps[i], param, V) << std::endl;
    ...
    std::cout << traj.ContRmin << " " << traj.DiscRmin << std::endl;
